...
/**
 * @brief Used to check the size allocated for the credentials in the NVS. 
 * 
...
/**
 * @brief For storing the new credentials to the NVS. Sizes of the credentials is not required.
 * 
 * @return ESP_OK on success
*/
